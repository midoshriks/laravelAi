...
<script src="{{ asset('./backend/layouts/js/simplebar.min.js') }}"></script>
<script src="{{ asset('./backend/layouts/js/daterangepicker.js') }}"></script>
<script src="{{ asset('./backend/layouts/js/jquery.stickOnScroll.js') }}"></script>
<script src="{{ asset('./backend/layouts/js/tinycolor-min.js') }}"></script>
<script src="{{ asset('./backend/layouts/js/config.js') }}"></script>
<script src="{{ asset('./backend/layouts/js/apps.js') }}"></script>
