                                ...
                                <div class="card-body" data-simplebar
                                    ...
                                    <div class="pb-3 timeline-item item-warning">
                                        <div class="pl-5">
                                            ...
                                            <div class="row mb-3">
                                                <div class="col"><img
                                                        src="{{ asset('./backend/layouts/assets/products/p1.jpg') }}"
                                                        alt="..." class="img-fluid rounded"></div>
                                                <div class="col"><img
                                                        src="{{ asset('./backend/layouts/assets/products/p2.jpg') }}"
                                                        alt="..." class="img-fluid rounded"></div>
                                                <div class="col"><img
                                                        src="{{ asset('./backend/layouts/assets/products/p3.jpg') }}"
                                                        alt="..." class="img-fluid rounded"></div>
                                                <div class="col"><img
                                                        src="{{ asset('./backend/layouts/assets/products/p4.jpg') }}"
                                                        alt="..." class="img-fluid rounded"></div>
                                            </div>
